...
export function ServiceCard({ servico }: ServiceCardProps) {
  ...
  return (
    <Card className="red-ring-hover group relative h-full overflow-hidden border-border/80 bg-card">
      {/* Vídeo de capa */}
      <div className="relative aspect-video overflow-hidden border-b border-border/60">
        ...
        <span className="absolute top-3 left-3 inline-flex items-center gap-1.5 rounded-full border border-white/30 bg-black/60 px-2.5 py-1 text-[10px] font-bold tracking-wide text-white/90 uppercase backdrop-blur">
      ...
      <CardContent className="flex flex-col gap-3 pt-4">
        <p className="line-clamp-2 min-h-10 text-sm leading-relaxed text-muted-foreground">
          {servico.descricao ?? "Atendimento com as melhores profissionais."}
        </p>
