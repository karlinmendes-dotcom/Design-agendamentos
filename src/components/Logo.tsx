...
export function Logo({ nome = "Barbearia Neto", className, compact }: LogoProps) {
  return (
    <div className={cn("flex items-center gap-2.5", className)}>
      <div className="relative flex size-9 shrink-0 items-center justify-center rounded-full border border-red-500/50 bg-gradient-to-br from-graphite to-charcoal shadow-[0_0_16px_-4px_rgba(225,6,0,0.6)]">
