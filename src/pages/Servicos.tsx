    ...
    <div className="min-h-screen bg-black">
      <section className="border-b border-border/60 bg-gradient-to-b from-[#120303] to-black pt-14 pb-10">
        <div className="mx-auto max-w-6xl px-5 sm:px-6">
          <div className="animate-slide-up max-w-2xl">
            ...
            {usandoDemo && (
              <p className="mt-3 inline-flex items-center gap-1.5 rounded-full border border-red-500/30 bg-red-500/10 px-3 py-1 text-xs text-red-300">
      ...
      <section className="mx-auto max-w-6xl px-5 py-14 sm:px-6">
        ...
        <Reveal className="mt-14">
          <div className="flex flex-col items-center gap-4 rounded-2xl border border-red-500/25 bg-gradient-to-r from-[#180505] to-black p-8 text-center sm:flex-row sm:justify-between sm:text-left">
            <div className="flex items-center gap-4">
              <div className="flex size-12 shrink-0 items-center justify-center rounded-lg border border-red-500/30 bg-red-500/10">
